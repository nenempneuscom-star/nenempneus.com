...
const MEDIDAS_VEICULOS: Record<string, string[]> = {
    ...
    'corsa': ['175/65 R14', '185/60 R15', '185/65 R15'],
    'corsa sedan': ['175/65 R14', '185/60 R15'],
    'corsa hatch': ['175/65 R14', '185/60 R15'],
    'astra': ['195/60 R15', '205/55 R16', '215/45 R17'],
    'vectra': ['205/55 R16', '215/50 R17', '225/45 R17'],
    'meriva': ['185/65 R15', '195/60 R15'],
    'zafira': ['195/65 R15', '205/55 R16'],
    'captiva': ['215/70 R16', '235/55 R18'],
